...
extern "C" {
	pub fn sodium_library_minimal() -> c_int;
}
extern "C" {
...
pub type crypto_aead_aes256gcm_state = [c_uchar; 512usize];
extern "C" {
...
extern "C" {
	pub fn crypto_aead_aes256gcm_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_aead_chacha20poly1305_ietf_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_aead_chacha20poly1305_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_aead_xchacha20poly1305_ietf_keygen(k: *mut c_uchar);
}
#[repr(C)]
#[derive(Copy, Clone)]
...
extern "C" {
	pub fn crypto_auth_hmacsha512_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_auth_hmacsha512256_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_auth_keygen(k: *mut c_uchar);
}
#[repr(C)]
#[derive(Copy, Clone)]
...
extern "C" {
	pub fn crypto_auth_hmacsha256_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_stream_xsalsa20_keygen(k: *mut c_uchar);
}
extern "C" {
...
fn bindgen_test_layout_crypto_generichash_blake2b_state() {
	...
	assert_eq!(
		unsafe {
			&(*(::std::ptr::null::<crypto_generichash_blake2b_state>())).buflen as *const _
				as usize
		},
		352usize,
		concat!(
...
extern "C" {
	pub fn crypto_generichash_blake2b_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_generichash_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_kdf_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_kx_keypair(pk: *mut c_uchar, sk: *mut c_uchar) -> c_int;
}
extern "C" {
	pub fn crypto_kx_client_session_keys(
		rx: *mut c_uchar,
		tx: *mut c_uchar,
		client_pk: *const c_uchar,
		client_sk: *const c_uchar,
		server_pk: *const c_uchar,
	) -> c_int;
}
extern "C" {
...
extern "C" {
	pub fn crypto_onetimeauth_poly1305_keygen(k: *mut c_uchar);
}
...
extern "C" {
	pub fn crypto_onetimeauth_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_secretbox_xsalsa20poly1305_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_secretbox_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_stream_chacha20_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_stream_chacha20_ietf_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_secretstream_xchacha20poly1305_tag_message() -> c_uchar;
}
extern "C" {
	pub fn crypto_secretstream_xchacha20poly1305_tag_push() -> c_uchar;
}
extern "C" {
	pub fn crypto_secretstream_xchacha20poly1305_tag_rekey() -> c_uchar;
}
extern "C" {
	pub fn crypto_secretstream_xchacha20poly1305_tag_final() -> c_uchar;
}
#[repr(C)]
...
extern "C" {
	pub fn crypto_secretstream_xchacha20poly1305_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_shorthash_keygen(k: *mut c_uchar);
}
#[repr(C)]
#[derive(Copy, Clone)]
...
extern "C" {
	pub fn crypto_sign_init(state: *mut crypto_sign_state) -> c_int;
}
extern "C" {
...
extern "C" {
	pub fn crypto_stream_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_stream_salsa20_keygen(k: *mut c_uchar);
}
extern "C" {
...
pub struct randombytes_implementation {
	pub implementation_name: ::std::option::Option<unsafe extern "C" fn() -> *const c_char>,
	...
	pub buf: ::std::option::Option<unsafe extern "C" fn(buf: *mut c_void, size: usize)>,
	pub close: ::std::option::Option<unsafe extern "C" fn() -> c_int>,
}
#[test]
...
extern "C" {
	pub fn sodium_runtime_has_neon() -> c_int;
}
extern "C" {
	pub fn sodium_runtime_has_sse2() -> c_int;
}
extern "C" {
	pub fn sodium_runtime_has_sse3() -> c_int;
}
extern "C" {
	pub fn sodium_runtime_has_ssse3() -> c_int;
}
extern "C" {
	pub fn sodium_runtime_has_sse41() -> c_int;
}
extern "C" {
	pub fn sodium_runtime_has_avx() -> c_int;
}
extern "C" {
	pub fn sodium_runtime_has_avx2() -> c_int;
}
extern "C" {
	pub fn sodium_runtime_has_avx512f() -> c_int;
}
extern "C" {
	pub fn sodium_runtime_has_pclmul() -> c_int;
}
extern "C" {
	pub fn sodium_runtime_has_aesni() -> c_int;
}
extern "C" {
	pub fn sodium_runtime_has_rdrand() -> c_int;
}
extern "C" {
...
extern "C" {
	pub fn sodium_is_zero(n: *const c_uchar, nlen: usize) -> c_int;
}
extern "C" {
	pub fn sodium_increment(n: *mut c_uchar, nlen: usize);
}
extern "C" {
	pub fn sodium_add(a: *mut c_uchar, b: *const c_uchar, len: usize);
}
extern "C" {
...
extern "C" {
	pub fn sodium_allocarray(count: usize, size: usize) -> *mut c_void;
}
extern "C" {
...
extern "C" {
	pub fn crypto_stream_xchacha20_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_core_ed25519_is_valid_point(p: *const c_uchar) -> c_int;
}
extern "C" {
...
extern "C" {
	pub fn crypto_stream_salsa2012_keygen(k: *mut c_uchar);
}
extern "C" {
...
extern "C" {
	pub fn crypto_stream_salsa208_keygen(k: *mut c_uchar);
}
